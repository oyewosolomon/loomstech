...
const Hero = () => {
  ...
  return (    
    <div className="bg-[#D1EE7C] min-h-screen ">
    <header className=" flex justify-between items-center md:bg-white md:mt-9 md:mx-[3rem] p-5 rounded-3xl">
        ...
        <nav className='hidden md:block'>
            ...
            <li><a href="#aboutus" className="text-gray-600 hover:text-lime-500">About us</a></li>
            <li><a href="#contactus" className="text-gray-600 hover:text-lime-500">Contact us</a></li>
            </ul>
        </nav>
    ...
    <main className="container mx-auto">
        <div className='flex flex-col md:flex-row justify-between items-center'>
            <div className="w-full md:w-1/2 text-center md:text-left mb-8 md:mb-0 px-0">
                <div className='mx-5'>
                <h1 className="text-3xl md:text-5xl lg:text-6xl lg:-mt-24 font-semibold text-green-800 mb-4 font-recoleta">
                Your Strategic Partner for Scalable Solutions
                </h1>
                <p className="text-md md:text-lg lg:text-2xl text-green-700 mb-6 font-lota">
                ...
                <button className="bg-green-700 text-white px-6 py-3 rounded-md flex items-center mx-auto md:mx-0">
                Connect with us
